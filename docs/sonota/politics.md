...
- そもそも、「夫婦別姓」よりも優先されるべき（上記のような）重要議題は多い。ここに述べた他にも、エネルギー・食糧政策、性自認に関する社会全体の取り組みのあり方や立法などは国民の生存権（憲法25条で保障）にもかかわる問題。このような優先度が高いとは言えない政策のために戸籍法や民法を改正するリスクを取るのは、本当に正しいことなのか。
